...
const styles = StyleSheet.create({
    ...
    subtitle: { fontSize: 16, color: '#666', lineHeight: 24, marginBottom: 20 },
    scrollArea: { flex: 1 },
    tagsContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 24 },
    tag: { paddingVertical: 10, paddingHorizontal: 16, borderRadius: 20, backgroundColor: '#F0F0F0' },
    tagSelected: { backgroundColor: '#4A8CFF' },
    tagText: { fontSize: 14, color: '#333', fontWeight: '600' },
    tagTextSelected: { color: '#FFF' },
    inputContainer: { flexDirection: 'row', gap: 10, alignItems: 'center', marginBottom: 20 },
    input: { flex: 1, backgroundColor: '#F6F6F9', padding: 16, borderRadius: 14, fontSize: 16 },
    addButton: { backgroundColor: '#333', padding: 16, borderRadius: 14, width: 56, alignItems: 'center' },
    addButtonText: { color: '#FFF', fontSize: 20, fontWeight: 'bold' },
    selectedList: { marginTop: 10, backgroundColor: '#F9F9F9', padding: 16, borderRadius: 12 },
    listItem: { fontSize: 14, color: '#444', marginBottom: 4 },
    nextButton: { backgroundColor: '#4A8CFF', borderRadius: 14, padding: 18, alignItems: 'center', marginTop: 16 },
